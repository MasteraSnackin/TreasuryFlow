...
export enum AuditEventType {
  ...
  EMERGENCY_PAUSE_ACTIVATED = 'EMERGENCY_PAUSE_ACTIVATED',
  EMERGENCY_PAUSE_DEACTIVATED = 'EMERGENCY_PAUSE_DEACTIVATED',
  
  // Bridge Events
  BRIDGE_TRANSFER_INITIATED = 'BRIDGE_TRANSFER_INITIATED',
  BRIDGE_TRANSFER_COMPLETED = 'BRIDGE_TRANSFER_COMPLETED',
  BRIDGE_TRANSFER_FAILED = 'BRIDGE_TRANSFER_FAILED',
